...
// COMPROBAR ACTUALIZACIONES GITHUB
...
function plugin_rugator_statistics_check_for_updates( $transient ) {
...
function plugin_rugator_statistics_add_update_link( $links, $file ) {
